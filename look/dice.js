...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-a75210a3');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-a75210a3');}
...
var brandEl=document.querySelector('.rl-brand-a75210a3');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
